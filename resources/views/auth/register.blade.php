...
@section('content')
   <div class="album text-muted">
    ...
    <div class="site-section bg-light">
      <div class="container">
        <h1 style="margin-left: 50px;">Seeker Registration</h1>   
        <div class="row">
            ...
            <form method="POST" action="{{route('register')}}" class="p-5 bg-white">
                        ...
                        <div class="form-group row">
                           <div class="col-md-12">Date of Birth</div>
                            <div class="col-md-12">
                                <input type="date" placeholder="DOB" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required>
